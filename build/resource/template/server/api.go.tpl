...
import (
	"gitlab.com/ucard/api/global"
    "gitlab.com/ucard/api/model/{{.Package}}"
    "gitlab.com/ucard/api/model/common/request"
    {{.Package}}Req "gitlab.com/ucard/api/model/{{.Package}}/request"
    "gitlab.com/ucard/api/model/common/response"
    "gitlab.com/ucard/api/service"
